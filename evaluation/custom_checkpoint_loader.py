#!/usr/bin/env python3
"""
Simple inference script that reads any images from input directory
No smart conversions - just loads whatever is there
"""
...
def main():
    ...
    print("="*60)
    print("SIMPLE BIODIVERSITY INFERENCE")
    print("="*60)
